...
export class NishthaDashboardComponent implements OnInit {
  ...
  //   }
  //  let params =  {
  //     'client_id': 'ntp-support-tool',
  //     'username': 'reportadmin@teamdiksha.org',
  //     'grant_type': 'password',
  //     'password': '',
  //     'client_secret': '58d30df4-c5c7-48d4-906c-aa33b673e3c2'
  //   }
  ...
  openWebview() {
    ...
    this.siteUrl = 'https://nishtha-dashboard.diksha.gov.in/login/?diksha_token='+token;
