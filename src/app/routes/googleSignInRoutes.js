...
const { GOOGLE_OAUTH_CONFIG, GOOGLE_OAUTH_CONFIG_IOS, GOOGLE_TEST_EMAILS, GOOGLE_OAUTH_TEST_CONFIG, GOOGLE_OAUTH_TEST_CONFIG_IOS } = require('../helpers/environmentVariablesHelper.js')
...
module.exports = (app) => {
  ...
  app.post('/google/auth/android', bodyParser.json(), async (req, res) => {
    ...
    logger.info("emailCreds::::::::::", CLIENT_ID); const client = new OAuth2Client(CLIENT_ID);
